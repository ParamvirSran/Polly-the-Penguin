...
// This function will base64 encode the audio buffer
std::string SpeechRecognizer::base64Encode(const std::vector<float> &buffer) {
    BIO *bio, *b64;
    BUF_MEM *bufferPtr;
...
std::string SpeechRecognizer::performSpeechRecognition(const std::vector<float> &audioBuffer) {
